...
if (isset($_POST["submit"]))
 {
   ...
   if ($result) {
      echo "
        <script>alert('Form successfully submitted');</script>";
        header("Location: /Online-Fashon-Store/pages/contact/index.php?msg=New record created successfully");
   } 
   else 
   {
...
<head>
    ...
    <link rel="stylesheet" href="/Online-Fashon-Store/assets/css/contactUs.css">
    <link rel="icon" href="/Online-Fashon-Store/assets/images/icon.png"/>
    ...
    <div class="container">
        ...
        <div class="contact-section">
            ...
            <div class="col">
               ...
               <input type="text" name="u_first_name" placeholder="YOUR FIRST NAME" required oninput="capitalization(this)">
            </div>
            <div class="col">
               <label>Last Name:</label>
               <input type="text" name="u_last_name" placeholder="YOUR LAST NAME" required oninput="capitalization(this)">
            </div>

            <div class="col">
                <label for="phone">Phone Number</label>
                <input type="tel" id="phone" name="u_phonenumber" placeholder="Your Phone Number" required oninput="checkLength(this)">
                <span id="errorMessage" style="color: red; font-size: 11px; margin-top: 1px "></span>
            </div>
         </div>
         ...
         <div class="button-group">
            <button type="submit" class="btn btn-success" name="submit" href="/Online-Fashon-Store/pages/contact/index.php" required >Save</button>
            <button type="button" onclick="window.location.href='ContactUs.php';">Check</button>
         </div>
        </div>
