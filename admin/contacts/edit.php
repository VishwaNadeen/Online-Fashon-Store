  ...
  <div class="container">
    ...
    <form action="#" method="post">
      ...
      <div class="button-group">
        ...
        <a href="/Online-Fashon-Store/admin/contacts/ContactUs.php" class="btn btn-danger">Cancel</a>
      </div>
    </form>
  </div>
...
<?php
  if (isset($_POST["submit"])) {
    ...
    if ($result) {
      header("Location: /Online-Fashon-Store/admin/contacts/ContactUs.php?msg=Data updated successfully");
    } else {
